...
@Repository
public interface Neo4jObjectIdentityRepository extends GraphRepository<Neo4jObjectIdentity> {
	public Neo4jObjectIdentity findByDomainObjectId(Long domainObjectId);
}
